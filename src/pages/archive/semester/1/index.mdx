...
**<EditIcon style={{ verticalAlign: 'middle', width: '16px', height: '16px' }} /> [Редактировать страницу](https://github.com/nawinds/m3104-links/edit/master/src/pages/archive/semester/1.mdx)**
